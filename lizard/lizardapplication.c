...
#define PIDGIN_PREFS_ROOT "change"
...
pidgin_application_startup(GApplication *application) {
	...
	purple_core_set_ui_ops(lizard_core_get_ui_ops());

	ui_info = purple_ui_info_new("pidgin3", "Lounge Lizard", "0.5",
	                             "https://pidgin.im",
	                             "https://developer.pidgin.im", "pc");

	if(!purple_core_init(ui_info, error)) {
		fprintf(stderr,
